...
from tkinter import Listbox, filedialog, messagebox, PhotoImage, Label, Scale, Scrollbar, Menu, END, RIGHT, Y, SINGLE, ACTIVE, HORIZONTAL
...
photo_blue_left = PhotoImage(file="./assets/leftmini.png")
photo_blue_right = PhotoImage(file="./assets/rightmini.png")

#IMAGES USED FOR LOGO NORMALMODE

#RIGHT LOGO
photo_red_right = PhotoImage(file="./assets/right red xn.png")
logo_right =Label(canvas, image=photo_red_right,bd=0)
logo_right.place(x=327,y=4.5)

#LEFT LOGO
photo_red_left = PhotoImage(file="./assets/left red xn.png")
